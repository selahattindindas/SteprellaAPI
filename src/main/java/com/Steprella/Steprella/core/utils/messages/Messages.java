...
public class Messages {
    ...
    public static class Error {
        ...
        public static final String CUSTOM_BANK_CARD_NOT_FOUND = "Yorum bulunamadı";
        ...
        public static final String INVALID_ORDER_STATUS_FOR_PAYMENT = "Ödeme işlemi için geçersiz sipariş durumu. Sadece bekleyen siparişler için ödeme yapılabilir.";
        public static final String PAYMENT_AMOUNT_MISMATCH = "Ödeme tutarı sipariş toplamı ile eşleşmiyor. Lütfen doğru tutarı giriniz.";
        public static final String PAYMENT_PROCESSING_FAILED = "Ödeme işlemi başarısız oldu. Lütfen daha sonra tekrar deneyiniz.";
        public static final String PAYMENT_ERROR = "Ödeme işlemi sırasında bir hata oluştu: %s";
    }
