...
public class CartItemController extends BaseController {
    ...
    public ResponseEntity<BaseResponse<List<ListCartItemResponse>>> getItemsByCartId(
        ...
        List<ListCartItemResponse> cartItems = cartItemService.getItemsByCartId(cartId, page, size);
        int totalCount = cartItemService.getTotalCount();

        return sendResponse(HttpStatus.OK, Messages.Success.CUSTOM_SUCCESSFULLY, cartItems, totalCount);
    }
